...
-(NSURL*) localURLForRemoteURL:(NSURL*) remoteURL{
    ...
    NSURL *dirURL = [remoteURL URLByDeletingLastPathComponent];
    
    NSString *dirName = [dirURL lastPathComponent];
    
    NSURL *newURL = [[[self class ]sandboxSubfolderURL]  URLByAppendingPathComponent:dirName isDirectory:YES];
    
    NSURL *finalURL = [newURL URLByAppendingPathComponent:fileName];
